...
const urlTicker = "https://api.bitpreco.com/btc-brl/ticker";                                const urlOrderbook = "https://api.bitpreco.com/btc-brl/orderbook";                          
function printPrice(lastPrice) {                      console.log("\nÚltimo preço negociado: " + yellow.bold(lastPrice));                 }
